...
SAFi is an open source governance engine for AI agents. It makes this principle operational by separating the governing standard from the processes that propose, select, evaluate, and integrate an agent’s responses and actions.
