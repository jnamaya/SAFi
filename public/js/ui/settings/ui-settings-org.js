                ...
                <div class="border-t border-gray-200 dark:border-neutral-700 pt-5">
                    ...
                    <div class="space-y-5">
                        ...
                        <div class="p-4 rounded-xl border border-green-200 dark:border-green-900/40 bg-green-50/50 dark:bg-green-900/10">
                            ...
                            <p class="text-xs text-gray-500 mt-1.5">Applies to every agent your members use, including the ones SAFi ships with: the checks follow the person typing, not the agent.</p>
