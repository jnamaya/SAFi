                    ...
                    <div class="space-y-5">
                        <div class="p-4 rounded-xl border border-blue-200 dark:border-blue-900/40 bg-blue-50/50 dark:bg-blue-900/10">
                            <label class="flex items-center gap-2 cursor-pointer select-none">
                                <input type="checkbox" id="charter-require-disclaimer" class="accent-blue-600 w-4 h-4"
                                    ${structuralData.require_disclaimer ? 'checked' : ''}>
                                <span class="text-sm font-semibold text-blue-800 dark:text-blue-200">Require a disclaimer on every response</span>
                            </label>
                            <input type="text" id="charter-disclaimer-text"
                                class="w-full mt-3 px-3 py-2 text-sm bg-white dark:bg-neutral-900 border border-blue-200 dark:border-blue-900/50 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none"
