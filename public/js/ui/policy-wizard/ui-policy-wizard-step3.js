...
export function renderScopeStep(container, policyData) {
    container.innerHTML = `
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 h-full">
            <div class="md:col-span-2 space-y-6">
                <div>
                    <div class="flex justify-between items-end mb-4">
                        ...
                        <button id="btn-gen-scope" class="shrink-0 text-xs bg-green-600 hover:bg-green-700 text-white px-3 py-1.5 rounded-full flex items-center gap-1.5 transition-colors font-medium">
                    ...
                    <textarea id="pw-scope-statement"
                        class="w-full h-64 p-5 rounded-xl border border-gray-300 dark:border-neutral-700 bg-white dark:bg-neutral-900 text-base leading-relaxed text-gray-800 dark:text-gray-200 focus:ring-2 focus:ring-green-500 outline-none resize-y"
            ...
            <div class="bg-green-50 dark:bg-neutral-800 p-6 rounded-2xl border border-green-100 dark:border-neutral-700 h-fit sticky top-6">
