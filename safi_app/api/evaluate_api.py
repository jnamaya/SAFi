...
async def evaluate_endpoint():
    ...
    try:
        ...
        if isinstance(result, dict):
            ...
            # Art. 50(2) machine-readable marking. evaluator_only: the
            # content was generated by the CALLER's agent — SAFi evaluated
            # (and possibly repaired) it, so the marker must not claim
            # SAFi generated it.
            result["aiProvenance"] = provenance.ai_marker(evaluator_only=True)
