...
const ICONS = {
    google_drive: `<svg class="w-5 h-5 shrink-0" viewBox="0 0 87.3 78" xmlns="http://www.w3.org/2000/svg"><path d="m6.6 66.85 3.85 6.65c.8 1.4 1.9 2.5 3.2 3.3l13.65-23.7c0 0 6.6 13.75 6.6 13.75z" fill="#0066da"/><path d="m43.65 25-13.65-23.7c-2.85 0-5.4 1.5-6.8 4l-13.65 23.65 13.65 23.65z" fill="#00ac47"/><path d="m73.55 76.8c2.85 0 5.4-1.5 6.8-4l3.85-6.65-13.65-23.65-13.65 23.65-6.8-11.8h-27.3z" fill="#ea4335"/><path d="m43.65 25 13.65-23.65c-1.4-2.55-3.95-4.05-6.8-4.05h-27.25z" fill="#00832d"/><path d="m59.8 50.3-13.65-23.65-13.65-23.65-13.75 23.85 13.75 23.65z" fill="#2684fc"/><path d="m73.4 76.8h-27.3l-13.65-23.65h27.3l13.65 23.65c1.4-2.5 1.4-5.5 0-8.05z" fill="#ffba00"/></svg>`,
    sharepoint: `<svg class="w-5 h-5 shrink-0" viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg"><path fill="#036C70" d="M99.8 135c-42.6 0-57.8-21.8-57.8-42.6 0-21.8 17.1-40.2 40.2-40.2 19.3 0 32.2 11.2 36.3 15.6l23.5-23.8C132.8 33.9 113.1 19 82.2 19 36.8 19 0 55.7 0 92.4c0 42.6 29.9 83.2 108.8 83.2 1.4 0 2.9 0 4.3-.1V135h-13.3z"/><path fill="#36C3CD" d="M123.6 135V80.5h13c42.6 0 57.8 21.8 57.8 42.6 0 21.8-17.1 40.2-40.2 40.2-19.3 0-32.2-11.2-36.3-15.6l-23.5 23.8c9.3 10.1 29 25 59.8 25 45.4 0 82.2-36.7 82.2-73.4C236.4 80.5 206.5 40 127.6 40c-1.3 0-2.7 0-4 .1V135h-13.3z"/></svg>`,
