...
> SAFi is an open source governance engine for AI agents. It lets institutions enforce their policies in real time, govern tool calls, and maintain an auditable record of every governed decision.
